                    ...
                    <div class="relative ml-3">
                        ...
                        <div id="dropdown-navbar"
                            ...
                            @forelse ($controlMenu as $menu)
                                <a href="{{ route($menu->route) }}"
                                    class="{{ activeRoute(url()->full(), $menu->name) > 1 ? 'text-indigo-700 dark:text-indigo-400' : 'text-black dark:text-indigo-600 hover:text-indigo-700 hover:dark:text-indigo-400' }} text-sm block px-4 py-2 rounded-t-lg"
