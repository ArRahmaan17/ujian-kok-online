...
@section('content')
    ...
    @endif
    <div
        class="grid {{ $usersRequested->isEmpty() ? 'grid-cols-1' : 'grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4' }} gap-3 p-3">
            ...
            <div
                ...
                <div class="p-6">
                    <h5 class="mb-2 leading-tight text-neutral-800 dark:text-neutral-50">
                        Reason To <br><span class="text-md">Change / Reset</span><br> Password
                    </h5>
                ...
                <div class="border-t-2 border-neutral-100 px-6 py-3 dark:border-indigo-600 dark:text-neutral-50 capitalize >
        ...
        @empty
            <div class="mt-24
                    mx-auto ">
                    <svg class="w-48 sm:w-1/4 xl:w-2/6 md:h-auto md:rounded-none rounded-full mx-auto "
                        xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="982.48732" height="763.01413"
                        viewBox="0 0 982.48732 763.01413" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <p class="dark:text-slate-500 dark:text-indigo-400 capitalize text-center mt-7 text-xl dark:text-2xl">
                        Not Found change Password Requests</p>
                </div>
        </div>
     @endforelse
