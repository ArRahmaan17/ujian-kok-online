        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-3">
                        <label for="route" class="block text-sm font-medium leading-6 text-gray-900">Route Name</label>
                        <div class="mt-2">
                    ...
                    <div class="sm:col-span-3">
                        <label for="position" class="block text-sm font-medium leading-6 text-gray-900 capitalize">menu
                            position</label>
                        <div class="mt-2">
                            <select id="position" name="position" autocomplete="country-name"
            ...
            <div class="border-b border-gray-900/10 pb-12">
                <h2 class="text-2xl font-semibold leading-7 text-gray-900 capitalize">Role management</h2>
                <p class="mt-1 text-md leading-6 text-gray-600 capitalize">
                    take control your user flow in your application
                </p>

                <div class="mt-10 space-y-10">
                    <fieldset>
                        <legend class="text-sm font-semibold leading-6 text-gray-900">By Role</legend>
                        <div class="mt-6 space-y-6">
                            ...
                            <div class="relative flex gap-x-3">
                                ...
                                <div class="text-sm leading-6">
                                    <label for="teacher" class="font-medium text-gray-900">Teacher</label>
                                </div>
                            </div>
                            <div class="relative flex gap-x-3">
                                <div class="flex h-6 items-center">
                                ...
                                <div class="text-sm leading-6">
                                    <label for="student" class="font-medium text-gray-900">Student</label>
                                </div>
                            </div>
                        </div>
                    </fieldset>
                    <fieldset>
                        <legend class="text-sm font-semibold leading-6 text-gray-900">On Maintenance</legend>
