...
@section('content')
    <div>
        <div class="px-4 sm:px-0">
            <h3 class="text-2xl font-semibold leading-7 text-gray-900 truncate dark:text-indigo-400">Class
        ...
        <div class="mt-6 border-t border-gray-100 dark:border-indigo-800">
            <dl class="divide-y divide-gray-100 dark:divide-indigo-800">
                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                    <dt class="text-sm font-medium leading-6 text-gray-900 dark:text-indigo-400">Class name</dt>
                    <dd class="mt-1 text-sm leading-6 text-gray-700 dark:text-indigo-200 sm:col-span-2 sm:mt-0">
                        {{ $classroom->name }}</dd>
                </div>
                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                    <dt class="text-sm font-medium leading-6 text-gray-900 dark:text-indigo-400">Homeroom Teacher</dt>
                    <dd class="mt-1 text-sm leading-6 text-gray-700 dark:text-indigo-200 sm:col-span-2 sm:mt-0">
                        {{ $classroom->homeroom->full_name }}</dd>
                </div>
                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                    <dt class="text-sm font-medium leading-6 text-gray-900 dark:text-indigo-400">Student Count</dt>
                    <dd class="mt-1 text-sm leading-6 text-gray-700 dark:text-indigo-200 sm:col-span-2 sm:mt-0">
                        {{ count($students) }} / <span class="text-slate-400">{{ $classroom->total_students }}</span>
                    </dd>
                </div>
                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                    <dt class="text-sm font-medium leading-6 text-gray-900 dark:text-indigo-400">Students</dt>
